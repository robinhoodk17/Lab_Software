...
Plot_folder = "C:/Users/rodrigudi/Documents/projects/R codes/clustering analysis/old graphs/"
...
(p = ggplot(WT_p, aes(Var2, Var1)) + geom_tile(aes(fill = value), colour = "white")+ scale_fill_gradient(low = c("red", "darkgoldenrod1","darkgoldenrod2","darkgoldenrod3", "darkgoldenrod4"), high = c("white"), space = "Lab") + geom_text(data = WT_r, aes(label = round(value,2)), size = base_size/3.33333) )
...
(q = ggplot(Treat_p, aes(Var2, Var1)) + geom_tile(aes(fill = value), colour = "white")+ scale_fill_gradient(low = c("red", "darkgoldenrod1","darkgoldenrod2","darkgoldenrod3", "darkgoldenrod4"), high = c("white"), space = "Lab") + geom_text(data = Treat_r, aes(label = round(value,2)), size = base_size/3.33333) )
...
(s = ggplot(comparison_colors, aes(Var2, Var1)) + geom_tile(aes(fill = value), colour = "white")+ scale_fill_gradient(low = c("red", "darkgoldenrod1","darkgoldenrod2","darkgoldenrod3", "darkgoldenrod4"), high = c("white"), space = "Lab") + geom_text(data = comparison, aes(label = round(value,2)), size = base_size/3.3333) )
